...
menuTimeline.fromTo(menuLinks, 
    ...
    { 
        ...
        stagger: 0.1              // Increased stagger for a more gradual reveal
    },
...
menuTimeline.eventCallback("onReverseComplete", () => {
    gsap.to(menuLinks, {
        ...
        stagger: -0.10            // Negative stagger for reverse order
    });
});
...
// Scroll-to-section functionality for each menu link
...
document.getElementById('menu-link-2').addEventListener('click', () => {
    gsap.to(window, { duration: 1, scrollTo: "#technology" });
});
